...
public class SalasFacadeREST extends AbstractFacade<Salas> {
    ...
    @PersistenceContext(unitName = "com.mycompany_mygimgrupo6_war_1.0-SNAPSHOTPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Salas entity) {
        super.edit(entity);
    }
    ...
    public Salas find(@PathParam("id") String id) {
